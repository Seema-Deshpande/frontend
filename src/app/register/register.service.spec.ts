...
describe('RegisterComponent', () => {
  ...
  beforeEach(async () => {
    ...
    toastrSpy = jasmine.createSpyObj('ToastrService', ['success', 'error']); // Create a spy for ToastrService
    ...
    await TestBed.configureTestingModule({
      imports: [
        ...
        NoopAnimationsModule // To avoid animation issues
      ],
      ...
      providers: [
        ...
        { provide: ToastrService, useValue: toastrSpy } // Provide the ToastrService spy
      ]
    }).compileComponents();
  });
  ...
  it('should call register method and navigate to login on success', () => {
    ...
    registerServiceSpy.register.and.returnValue(of({})); // Simulate successful registration
  ...
  it('should handle registration error', () => {
    ...
    // Set some form values (make sure they meet the validation requirements)
